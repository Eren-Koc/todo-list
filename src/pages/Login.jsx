...
let logincontrol =false;
  ...
  return (
    ...
    <span className='title font-bold text-3xl text-app-black'>{isProgressLogin ? "Login" : "Sign up"}</span>
    <span className='to-start-planing font-medium my-2'>to start planing</span>
        ...
        <input onClick={()=>{Login_OR_Signup()}} className='w-full duration-300 ease-in-out hover:bg-[#4191F0] py-3 outline-none rounded-sm font-semibold text-white mt-8 cursor-pointer bg-app-blue' value={isProgressLogin ? "Login" : "Sign up"} type="submit" />
